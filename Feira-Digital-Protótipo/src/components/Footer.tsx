        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Connecting communities with local artisans, farmers, and craftspeople since 2020.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-4">Quick Links</h3>
            <ul className="space-y-2 text-gray-400 text-sm">
              <li><a href="#" className="hover:text-[#D4745F] transition-colors">About Us</a></li>
              <li><a href="#" className="hover:text-[#D4745F] transition-colors">How It Works</a></li>
              <li><a href="#" className="hover:text-[#D4745F] transition-colors">Become a Vendor</a></li>
