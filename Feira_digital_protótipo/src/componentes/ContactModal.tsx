    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl p-6 max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-[#2C2C2C]">Contatar {recipientName}</h2>
        ...
        {submitted ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-bold text-[#2C2C2C] mb-2">Mensagem Enviada!</h3>
            <p className="text-gray-600">Notificaremos {recipientName} sobre sua mensagem.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Seu Nome</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Seu Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-sm font-semibold text-[#2C2C2C] mb-2">Mensagem</label>
              <textarea
                value={message}
